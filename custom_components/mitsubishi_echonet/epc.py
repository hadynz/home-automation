	...
	0x01: { # Air conditioner-related device class group
		0x30: { # Home air conditioner class
			...
			"functions": {
				...
				0xB7: ('Set temperature value in dehumidifying mode', None),
				...
				0xC2: ('Ventilation air flow rate setting', None),
				0xC4: ('Degree of humidification setting', None),
				0xC6: ('Mounted air cleaning method', None),
				0xC7: ('Air purifier function setting', None),
				0xC8: ('Mounted air refresh method', None),
				0xC9: ('Air refresher function setting', None),
				0xCA: ('Mounted self-cleaning method', None),
				0xCB: ('Self-cleaning function setting', None),
				0xCC: ('Special function setting', None),
				0xCD: ('Operation status of components', None),
				0xCE: ('Thermostat setting override function', None),
				0xCF: ('Air purification mode setting', None),
				0x90: ('ON timer-based reservation setting', None),
				0x91: ('ON timer setting (time)', None),
				0x92: ('ON timer setting (relative time)', None),
				0x94: ('OFF timer-based reservation setting', None),
				0x95: ('OFF timer setting (time)', None),
				0x96: ('OFF timer setting (relative time)', None)
			}
		},
...
EPC_SUPER = {
	...
	0x8E: ('Production date', None),
	0x8F: ('Power-saving operation setting', None),
	0x93: ('Remote control setting', None),
	0x97: ('Current time setting', None),
	0x98: ('Current date setting', None),
	0x99: ('Power limit setting', None),
	0x9A: ('Cumulative operating time', None),
